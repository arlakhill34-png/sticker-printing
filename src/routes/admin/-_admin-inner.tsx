...
function AdminContent({
    ...
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent side="top" align="start" className="w-52">
          ...
          <DropdownMenuLabel className="text-xs font-normal text-sidebar-foreground/55">
            {user?.companyEmail}
          </DropdownMenuLabel>
          <DropdownMenuSeparator />
          <DropdownMenuItem
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-y-0 left-0 z-50 w-72 bg-sidebar text-sidebar-foreground transition-transform duration-300 ease-in-out md:hidden"
